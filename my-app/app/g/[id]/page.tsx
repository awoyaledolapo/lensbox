    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="border-b border-hairline">
        ...
        <div className="mx-auto mt-14 max-w-[1500px] px-6 sm:px-10">
          <span className="eyebrow text-muted-foreground">Presented by Maren Hollis Studio</span>
        ...
        <div className="relative mx-auto mt-14 aspect-[16/9] max-w-[1500px] overflow-hidden bg-muted">
          <Image src={gallery.cover} alt={gallery.title} fill className="object-cover" />
        </div>
      </header>
      ...
      <section className="mx-auto max-w-[1500px] px-6 py-16 sm:px-10 sm:py-24">
        ...
        <div className="columns-1 gap-5 sm:columns-2 lg:columns-3">
          {photos.map((src, i) => {
            ...
            return (
              <figure key={i} className="group relative mb-5 break-inside-avoid">
                <button
      ...
      <footer className="border-t border-hairline py-10 text-center text-xs text-muted-foreground">
        Presented on <Link href="/" className="underline">LensBox</Link> · Maren Hollis Studio © 2026
      </footer>
